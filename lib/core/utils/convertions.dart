...
class Convertions {
  ...
  static Session responseToSession(Map<String, Object?> response) {
    return Session(
      ...
      serverId: response['server_id'] as int?, 
      userId: response['user_id'] as int?,
      startedAt: response['started_at'] != null ? DateTime.fromMicrosecondsSinceEpoch(response['started_at'] as int) : null,
      finishedAt: response['finished_at'] != null ? DateTime.fromMicrosecondsSinceEpoch(response['finished_at'] as int) : null,
  ...
  static RecordRepetition responseToRecordRepetition(Map<String, Object?> response) {
    return RecordRepetition(
      ...
      forDate: response['for_date'] != null ? DateTime.fromMicrosecondsSinceEpoch(response['for_date'] as int) : null,
